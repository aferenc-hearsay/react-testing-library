    ...
    articles: [
      {
        ...
        sections: [
          {
            sectionSequenceId: 0,
            content: '<p>As the plugin define itself, it is a plugin for ESLint that checks your code to follow best ' +
      ...
      },
      {
        ...
        sections: [
          {
            sectionSequenceId: 0,
            content: '<p>Add testing-library to the plugins section of your .eslintrc.js configuration file. You can ' +
          ...
          {
            sectionSequenceId: 2,
            content: '<p>Then configure the rules you want to use under the rules property of your .eslintrc:.</p>'
          },
          {
            sectionSequenceId: 3,
            content: '<p><code>module.exports = {<br>&nbsp;rules: {' +
